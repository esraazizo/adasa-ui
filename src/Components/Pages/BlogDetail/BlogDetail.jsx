...
function BlogDetail() {
  ...
  const targetpost = data.posts.find((blog) => blog.slug == slug);
              ...
              <div className="order-2 lg:order-1">
                ...
                <div className="prose-custom">
                  <ReactMarkdown
                    ...
                    components={{
                      h2: ({ node, ...props }) => (
                        <h2 className="text-2xl md:text-3xl font-bold text-white mt-14 mb-6 flex items-center gap-4 scroll-mt-24">
                      ...
                      p: ({ node, ...props }) => (
                        <p
                          className="text-neutral-300 leading-relaxed mb-6 text-lg whitespace-pre-line"
                          {...props}
                        />
                      ),
                    }}
